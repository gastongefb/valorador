...
<script>
    ...
    <div class="cap">
        <h3>Capacitación 1</h3>
         <!-- Nuevo campo de selección -->
         <label for="opciones1">Seleccione opción:</label>
        <select name="cap[1][opciones]" id="opciones1">
        ...
        <label for="detalle1">Detalle:</label>
        <input type="text" name="cap[1][detalle_capacitacion]" id="detalle_capacitacion1">
        <br>
        <br>
        <label for="fecha1">Fecha:</label>
        <input type="text" name="cap[1][fecha]" id="fecha1">
        <br>
        <br>
        <label for="cantidad1">Cantidad:</label>
        <input type="text" name="cap[1][cantidad]" id="cantidad1"><br>
        <br> 
        <button type="button" class="removeCap">Eliminar Capacitación</button>
    </div>
</div>
<br>
<button type="button" id="addCap">Agregar Capacitación</button>
...
<script>
    ...
    <div class="doc">
        <h3>Antecedentes 1</h3>
         <!-- Nuevo campo de selección -->
         <label for="opciones1">Seleccione opción:</label>
        <select name="doc[1][opciones]" id="opciones1">
        ...
        <br>
        <label for="fecha1">Fecha:</label>
        <input type="text" name="docs[1][fecha]" id="fecha1"><br>
        <br>       
        <button type="button" class="removeDoc">Eliminar Título</button>
    </div>
</div>
<br>
<button type="button" id="addDoc">Agregar Antecedentes Docentes</button>
